...
public abstract class GameObj {
    ...
    public boolean willIntersect(GameObj that) {
        int thisNextX = this.px + 20;
        int thisNextY = this.py + 20;
        int thatNextX = that.px + 20;
        int thatNextY = that.py + 20;

        return (thisNextX + 10 >= thatNextX
                && thisNextY + 10 >= thatNextY
                && thatNextX + 10 >= thisNextX
                && thatNextY + 10 >= thisNextY);
    }
